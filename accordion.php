...
class Widget_Accordion extends Widget_Base {
	...
	public function get_style_depends() {
        wp_register_style( "viva-css", get_theme_file_uri('css/style.css'), array(), false, "all" );
        return [
            'viva-css'
        ];
    }
	...
	protected function register_controls() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .elementor-accordion-icon.elementor-accordion-icon-left.accordion-right' => 'margin-right: {{SIZE}}{{UNIT}};',
